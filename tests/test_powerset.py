...
class TestPowerset(unittest.TestCase):
    ...
    def test_powerset_len(self):
        test_in = [1, 2, 3]
        self.assertEqual(len(list(powerset(test_in))), pow(2, len(test_in)) - 1, "Length test failed!")

    def test_powerset_deep_comparison(self):
        test_in = [1, 2, 3]
        expected_result = [(1,), (2,), (3,), (1, 2,), (1, 3), (2, 3,), (1, 2, 3,)]
        self.assertListEqual(list(powerset(test_in)), expected_result, 'Deep comparison failed!')
